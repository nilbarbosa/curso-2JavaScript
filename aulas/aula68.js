...
const num_object=document.getElementById("num_object")
...
class Bola{
    constructor(arrayBolas,palco){
        ...
        this.palco=this.palco
        this.arrayBolas=this.arrayBolas
        this.id=Date.now()+"_"+Math.floor(Math.random()*100100100100)
        this.desenhar()
        this.controle=setInterval(this.controlar,10)

        this.eu=document.getElementById(this.id)
        numBola++
        num_object.innerHTML=numBola
    }
    minhaPos=()=>{
